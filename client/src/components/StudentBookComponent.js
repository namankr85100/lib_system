...
render(){
 ...
 return (
    ...
    <div className="col-12">
  <h3 align="center">  Issue a book to colleague</h3>
  </div>
    </div>
    <div className="row row-content justify-content-center">
    <LocalForm onSubmit={(values) => {
        this.props.studentIssuedPostBook(values.name, values.author, values.description, values.isbn, values.cat, values.copies, values.friend, values.issue_type);
    }}>
                            ...
                            <Row className="form-group">
                                ...
                                <Col md={3}>
                                    <Control.text model=".friend" id="friend" name="friend"
                                        ...
                                        className="form-control"
                                        validators={{
                                            requiredNum, minLength: minLength(3)
                                        }}
                                         />
                                    <Errors
                                        className="text-danger"
